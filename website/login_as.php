...
<head>
    ...
    <title>Login As - Look Back Café</title>
...
<body>
    ...
    <div class="login-card">
        ...
        <p class="login-label">Login as:</p>
        
        <div class="buttons-container">
            <a href="as_user.php" class="login-button">User</a>
            <a href="as_admin.php" class="login-button">Admin</a>
        </div>
    </div>
</body>
</html>