...
<head>
    ...
    <title>Password Changed - Look Back Café</title>
    <link rel="stylesheet" href="../resources/css/login_as.css">
    <link rel="stylesheet" href="../resources/css/pass_change_success.css">
...
<body>
    ...
    <div class="login-card">
        ...
        <h2 class="welcome-text">Password Changed!</h2>
        <p class="welcome-subtext">Your password has been changed successfully.</p>
        
        <a href="as_user.php" class="submit-button">Continue</a>
    </div>
</body>
</html>